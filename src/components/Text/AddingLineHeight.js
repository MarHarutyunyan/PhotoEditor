...
export const AddingLineHeight = ({ selected, layers }) => {
    ...
    const changeCountBy = (num) => {
        dispatch({ type: "CHANGE_LINE_HEIGHT", lineHeight: Math.max(0, layers[selected[0]].meta.TxtMeta.lineHeight + num), selected });
    }
    ...
    return (
        <div>
            ...
            <input type="number" value={layers[selected[0]].meta.TxtMeta.lineHeight} onChange={changeCountBy} />
